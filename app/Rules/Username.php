...
/**
 * Credits: https://github.com/pinkary-project/pinkary.com
 *
...
class Username implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        if (preg_match('/[A-Za-z].*[A-Za-z]/', $value) === 0) {
            $fail('The :attribute field must contain at least 2 letters.');

            return;
        }

        if (preg_match('/^\w+$/', $value) === 0) {
            $fail('The :attribute field may only contain letters, numbers, and underscores.');
        ...
        $query = User::query()
            ...
            ->when(
                $this->user,
                fn (Builder $query, User $user) => $query->where('id', '!=', $user->id),
            );
